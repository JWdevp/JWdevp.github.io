...
```ts
logo: 'images/projects/lfstat-logo.png',
```

A transparent PNG or an SVG works best. Bear in mind that an official emblem is
someone else's mark: showing a client's logo in a portfolio is common, but it is
your call to make.
